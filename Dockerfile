...
RUN echo "deb http://repo.saltstack.com/apt/debian/10/amd64/archive/${SALT_VERSION} stretch main" > /etc/apt/sources.list.d/salt.list
ADD https://repo.saltstack.com/apt/debian/10/amd64/archive/${SALT_VERSION}/SALTSTACK-GPG-KEY.pub /tmp/SALTSTACK-GPG-KEY.pub
